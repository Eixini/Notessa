...
class ShowVideoNoteWindow(QDialog):
    def __init__(self,  noteData: list):
        ...
        self._file_path = f'{_dir_checker.video_notes_directory()}{QDir.separator()}{self.noteData[1]}.{self.noteData[0]}'
        ...
        self._media_player.setVideoOutput(self.ui.videoWidget)
        ...
        self.ui.durationSlider.sliderMoved.connect(self.change_duration_slider)
    ...
    def play(self):
        ...
        self.ui.durationSlider.setMaximum(self._media_player.duration())
    ...
    def on_position_changed(self):
        ...
        self.ui.positionLabel.setText(f'{position["min"]}:{position["sec"]}')
        self.ui.durationSlider.setValue(self._media_player.position())

    def change_duration_slider(self):
        self._media_player.setPosition(self.ui.durationSlider.value())
